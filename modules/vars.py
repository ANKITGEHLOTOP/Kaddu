...
BOT_TOKEN = environ.get("BOT_TOKEN", "8203512235:AAEnHM0EcRpsC4juUx6Qlpze5CPc9Muyqfc")

OWNER = int(environ.get("OWNER", "8102112566"))
CREDIT = environ.get("CREDIT", "Papa")
cookies_file_path = os.getenv("cookies_file_path", "youtube_cookies.txt")

TOTAL_USER = os.environ.get('TOTAL_USERS', '8102112566').split(',')
TOTAL_USERS = [int(user_id) for user_id in TOTAL_USER]

AUTH_USER = os.environ.get('AUTH_USERS', '8455144672').split(',')
